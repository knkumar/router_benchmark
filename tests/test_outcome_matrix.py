...
def test_historical_bfcl_records_fail_route_equivalence_audit() -> None:
    rows = [
        {
            "benchmark_name": "BFCL v4 (live)", "task_id": "task-1", "trial": "0",
            "selected_candidate": "mid-general", "success": "True", "cost_usd": "0.1", "latency_ms": "10",
        },
        {
            "benchmark_name": "BFCL v4 (live)", "task_id": "task-1", "trial": "0",
            "selected_candidate": "mid-general", "success": "False", "cost_usd": "0.1", "latency_ms": "10",
        },
    ]
