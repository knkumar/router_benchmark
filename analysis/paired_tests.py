...
def paired_effects(
    ...
    analysis_protocol_path = analysis_protocol_path or ROOT / "protocol/analysis.yaml"
...
def main() -> None:
    ...
    parser.add_argument("--analysis-protocol", type=Path, default=ROOT / "protocol/analysis.yaml")
